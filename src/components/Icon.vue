...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'explorer'">
      <path d="M3 5h7l2 2h9" /><path d="M3 5v14h18V7" />
    </template>
    ...
    <template v-else-if="name === 'git'">
      ...
      <path d="M6 8.4v7.2" /><path d="M18 11.4a6 6 0 0 1-6 6H8.4" />
    </template>
    <template v-else-if="name === 'extensions'">
      <path d="M7 3h4v4h2V3h4v4h4v4h-4v2h4v4h-4v4h-4v-4h-2v4H7v-4H3v-4h4v-2H3V7h4z" />
    </template>
